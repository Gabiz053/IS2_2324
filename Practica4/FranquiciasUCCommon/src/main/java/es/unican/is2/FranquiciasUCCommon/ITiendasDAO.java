...
public interface ITiendasDAO {
	 ...
	 * @return La tienda anhadida null si ya existe una tienda con el mismo id
	 ...
	 * @return La tienda buscada null si no se encuentra
	 * @throws DataAccessException Si hay un error en el acceso a los datos
	 */
	 ...
	 * @return Tienda actualizada null si no existe una tienda con el mismo id
	 * @throws DataAccessException Si hay un error en el acceso a los datos
	 */
	 ...
	 * @return Tienda eliminada null si no se encuentra la tienda
	 * @throws DataAccessException Si hay un error en el acceso a los datos
	 */
	 ...
	 * 
	 * @return Lista de tiendas Lista vacia si no hay ninguna tienda
	 * @throws DataAccessException Si hay un error en el acceso a los datos
	 */
