...
public interface IGestionTiendas {
	 ...
	 * @return La tienda anhadida null si no se anhade porque ya existe
	 ...
	 * @return La tienda eliminada null si no se elimina porque no se encuentra
	 ...
	 * @return La tienda buscada null si no existe
	 * @throws DataAccessException Si hay un error en el acceso a los datos
	 */
