...
public interface IEmpleadosDAO {
	 ...
	 * @return El empleado una vez anhadido null si ya existe un empleado con el
	 *         mismo dni
	 ...
	 * @return El empleado eliminado null si no se encuentra el empleado
	 * @throws DataAccessException Si hay un error en el acceso a los datos
	 */
	 ...
	 * @return Empleado actualizado null si no existe
	 * @throws DataAccessException Si hay un error en el acceso a los datos
	 */
	 ...
	 * 
	 * @param dni DNI del empleado
	 * @return El empleado buscado null si no se encuentra
	 * @throws DataAccessException Si hay un error en el acceso a los datos
	 */
	 ...
	 * 
	 * @return La lista de empleados Lista vacia si no hay ninguno
	 * @throws DataAccessException Si hay un error en el acceso a los datos
	 */
