...
/**
 * Clase que representa una tienda de la franquicia. Almacena sus datos y su
 * lista de empleados El nombre de la tienda es unico en la franquicia
 */
...
public class Tienda implements Serializable {
	...
	/**
	 * Retorna el gasto mensual de la tienda en pagar sueldos de sus empleados.
	 * 
	 ...
	 * @return Empleado con ese dni null si no existe
	 */
