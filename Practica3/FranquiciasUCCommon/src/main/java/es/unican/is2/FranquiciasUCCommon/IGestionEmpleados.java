...
public interface IGestionEmpleados {
	 ...
	 * @return El empleado a�adido null si no se anhade porque no existe la tienda
	 ...
	 * @param nombre Nombre de la tienda
	 * @return El empleado eliminado null si el empleado o la tienda no existen
	 * @throws OperacionNoValidaException Si el empleado no pertenece a la tienda
	 *                                    indicada
	 * @throws DataAccessException        Si hay un error en el acceso a los datos
	 */
	 ...
	 * @return true si se traslada al empleado exitosamente false si no se traslada
	 *         porque el empleado o alguna de las tiendas no existen
	 * @throws OperacionNoValidaException Si el empleado existe pero no pertenece a
	 *                                    la tienda actual
	 * @throws DataAccessException        Si hay un error en el acceso a los datos
	 */
	 ...
	 * 
	 * @param dni
	 * @return El empleado con el dni indicado null si no existe
	 * @throws DataAccessException Si hay un error en el acceso a los datos
	 */
